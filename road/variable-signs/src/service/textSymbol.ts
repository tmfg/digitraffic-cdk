...
function addSymbol(name: string, width: number, svg: string, id: string = name): void {
    const tieSvg =
...
function addSingle(name: string, width: number, svg: string, id: string = name): void {
    SYMBOL_CACHE[SymbolType.SINGLE + id] = new TextSymbol(width, svg, name, SymbolType.SINGLE);
}

function addEnd(name: string, width: number, svg: string, id: string, symbolType: SymbolType): void {

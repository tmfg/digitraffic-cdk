...
export const TEST_TIMES = [
    {
        start: new Date("2024-05-20T19:00:00.00Z"), end: new Date("2024-05-21T02:00:00.00Z")
    }, 
    {
        start: new Date("2024-05-21T19:00:00.00Z"), end: new Date("2024-05-22T02:00:00.00Z")
    }
] as const;
...
function isTestTime(time: Date): boolean {
    ...
    return TEST_TIMES.find(tt => tt.start.getTime() <= timeMs && tt.end.getTime() > timeMs) !== undefined;
}

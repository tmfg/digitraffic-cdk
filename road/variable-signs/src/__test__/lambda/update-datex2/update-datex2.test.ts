...
describe(
  ...
  dbTestBase((db) => {
    ...
    test("update_valid_datex2", async () => {
      ...
      const [datex2, lastModified] = await VariableSignsService
        .findActiveSignsDatex2();
    ...
    test("insert_update", async () => {
      ...
      const [oldDatex2, lastModified1] = await VariableSignsService
        .findActiveSignsDatex2();
      ...
      const [newDatex2, lastModified2] = await VariableSignsService
        .findActiveSignsDatex2();
...
async function updateFile(
  ...
  const { handler } = await import(
    "../../../lambda/update-datex2/update-datex2.js"
  );

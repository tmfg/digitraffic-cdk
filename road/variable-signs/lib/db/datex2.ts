...
const SQL_INSERT_DATEX2 = `insert into device_data_datex2(device_id,datex2,effect_date,updated_timestamp)
values($1, $2, $3, $4)
...
const SQL_SELECT_ALL_ACTIVE = `select datex2 from device_data_datex2 ddd, device

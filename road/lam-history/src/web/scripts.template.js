...
const raaka_liikenne_tasot = [
    { key: "h", value: "<%= liikennetasot.raaka_h %>", tformat: time_formats.date },
    {
        key: "vrk",
...
const liikenne_tasot = {
    h: { key: "h", value: "<%= liikennetasot.liikenne_h %>", tformat: time_formats.hour },
    vrk: {
        key: "vrk",
        value: "<%= liikennetasot.liikenne_vrk %>",
        tformat: time_formats.date
    },
    vk: { key: "vk", value: "<%= liikennetasot.liikenne_vk %>", tformat: time_formats.week },
    kk: {
        key: "kk",
        value: "<%= liikennetasot.liikenne_kk %>",
        tformat: time_formats.month
    },
    v: { key: "v", value: "<%= liikennetasot.liikenne_v %>", tformat: time_formats.year },
    kvlv: {
        key: "kvl",
        value: "<%= liikennetasot.liikenne_kvl1 %>",
        tformat: time_formats.year_d
    },
    kvl: {
        key: "kvl",
        value: "<%= liikennetasot.liikenne_kvl2 %>",
        tformat: time_formats.year
    },
    kavlv: {
        key: "kavl",
        value: "<%= liikennetasot.liikenne_kavl1 %>",
        tformat: time_formats.year_d
    },
    kavl: {
        key: "kavl",
        value: "<%= liikennetasot.liikenne_kavl2 %>",
        tformat: time_formats.year
    }
};

const knopeus_tasot = {
    h: { key: "h", value: "<%= nopeustasot.h %>", tformat: time_formats.hour },
    vrk: {
        key: "vrk",
        value: "<%= nopeustasot.vrk %>",
        tformat: time_formats.date
    },
    vk: { key: "vk", value: "<%= nopeustasot.vk %>", tformat: time_formats.week },
    kk: {
        key: "kk",
        value: "<%= nopeustasot.kk %>",
        tformat: time_formats.month
    },
    v: { key: "v", value: "<%= nopeustasot.v %>", tformat: time_formats.year }
};

const aineistot = {
    liikennemaara: {
        key: "liikennemaara",
        value: "<%= aineistot.liikennemaara %>",
        summaustasot: liikenne_tasot
    },
    raakaliikennemaara: {
        key: "raakaliikennemaara",
        value: "<%= aineistot.raakaliikennemaara %>",
        summaustasot: raaka_liikenne_tasot
    },
    keskinopeus: {
        key: "keskinopeus",
        value: "<%= aineistot.keskinopeus %>",
        summaustasot: knopeus_tasot
    }
};

const ajoneuvot = [
    { key: "(*):Kaikki", luokka: "kaikki", value: "<%= vehicles.kaikki %>" },
    {
        key: "(1,6,7,8):kevyet",
        luokka: "kevyet",
        value: "<%= vehicles.kevyet %>"
    },
    {
        key: "(2,3,4,5,9):raskaat",
        luokka: "raskaat",
        value: "<%= vehicles.raskaat %>"
    },
    { key: "1:1_ha_pa", luokka: "1", value: "<%= vehicles.luokka1 %>" },
    { key: "2:2_ka_ip", luokka: "2", value: "<%= vehicles.luokka2 %>" },
    { key: "3:3_la", luokka: "3", value: "<%= vehicles.luokka3 %>" },
    { key: "4:4_ka_pp", luokka: "4", value: "<%= vehicles.luokka4 %>" },
    { key: "5:5_ka_tp", luokka: "5", value: "<%= vehicles.luokka5 %>" },
    { key: "6:6_ha_pk", luokka: "6", value: "<%= vehicles.luokka6 %>" },
    { key: "7:7_ha_av", luokka: "7", value: "<%= vehicles.luokka7 %>" },
    { key: "8:8_mp", luokka: "8", value: "<%= vehicles.luokka8 %>" },
    { key: "9:9_hct", luokka: "9", value: "<%= vehicles.luokka9 %>" }
];

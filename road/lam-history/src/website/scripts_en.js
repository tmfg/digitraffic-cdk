...
const liikenne_tasot = {
  h: {
    key: "h",
    value: "Hourly traffic volume",
    tformat: time_formats.hour,
  },
  vrk: {
    key: "vrk",
    value: "Daily traffic volume",
    tformat: time_formats.date,
  },
  vk: {
    key: "vk",
    value: "Weekly traffic volume",
    tformat: time_formats.week,
  },
  kk: {
    key: "kk",
    value: "Monthly traffic volume",
    tformat: time_formats.month,
  },
  v: {
    key: "v",
    value: "Yearly traffic volume",
    tformat: time_formats.year,
  },
  kvlv: {
    key: "kvl",
    value: "Average daily traffic volume (free time period)",
    tformat: time_formats.year_d,
  },
  kvl: {
    key: "kvl",
    value: "Average daily traffic volume for a year",
    tformat: time_formats.year,
  },
  kavlv: {
    key: "kavl",
    value: "Average weekday traffic volume (free time period)",
    tformat: time_formats.year_d,
  },
  kavl: {
    key: "kavl",
    value: "Average weekday daily traffic volume for a year",
    tformat: time_formats.year,
  },
};

const knopeus_tasot = {
  h: { key: "h", value: "Hourly average speed", tformat: time_formats.hour },
  vrk: {
    key: "vrk",
    value: "Daily average speed",
    tformat: time_formats.date,
  },
  vk: { key: "vk", value: "Weekly average speed", tformat: time_formats.week },
  kk: {
    key: "kk",
    value: "Monthly average speed",
    tformat: time_formats.month,
  },
  v: { key: "v", value: "Yearly average speed", tformat: time_formats.year },
};

const aineistot = {
  liikennemaara: {
    key: "liikennemaara",
    value: "Traffic volume (quality controlled)",
    summaustasot: liikenne_tasot,
  },
  raakaliikennemaara: {
    key: "raakaliikennemaara",
    value: "Raw traffic volume data",
...
const ajoneuvot = [
  { key: "(*):Kaikki", luokka: "kaikki", value: "All (sum)" },
  {
    key: "(1,6,7,8):kevyet",
    luokka: "kevyet",
    value: "Light vehicles (classes 1,6,7,8)",
  },
  {
    key: "(2,3,4,5,9):raskaat",
    luokka: "raskaat",
    value: "Heavy vehicles (classes 2,3,4,5,9)",
  },
  { key: "1:1_ha_pa", luokka: "1", value: "1 Passenger car or van" },
  { key: "2:2_ka_ip", luokka: "2", value: "2 Truck without trailer" },
  { key: "3:3_la", luokka: "3", value: "3 Bus" },
  { key: "4:4_ka_pp", luokka: "4", value: "4 Truck and semi-trailer" },
  { key: "5:5_ka_tp", luokka: "5", value: "5 Truck and full trailer" },
  { key: "6:6_ha_pk", luokka: "6", value: "6 Passenger car and trailer" },
  { key: "7:7_ha_av", luokka: "7", value: "7 Passenger car and caravan" },
  { key: "8:8_mp", luokka: "8", value: "8 Motorcycles and mopeds" },

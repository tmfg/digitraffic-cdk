...
export class InternalLambdasCdk {
    constructor(stack: DigitrafficStack) {
        const updateDataForAutoriOuluLambda = InternalLambdasCdk.createUpdateDataLambdaForAutori(
            stack,
            "autori-oulu",
            5
        );
        const updateDataForAutoriKuopioLambda = InternalLambdasCdk.createUpdateDataLambdaForAutori(
            stack,
            "autori-kuopio",
            5
        );
        const updateDataForPaikanninKuopioLambda = InternalLambdasCdk.createUpdateDataLambdaForPaikannin(
            stack,
            "paikannin-kuopio",
            5
        );

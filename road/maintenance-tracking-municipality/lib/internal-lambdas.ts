...
export class InternalLambdas {
    constructor(stack: DigitrafficStack) {
        const updateDataForAutoriOuluLambda =
            InternalLambdas.createUpdateDataLambdaForAutori(
                stack,
                "autori-oulu",
                5
            );
        const updateDataForAutoriKuopioLambda =
            InternalLambdas.createUpdateDataLambdaForAutori(
                stack,
                "autori-kuopio",
                5
        ...
        const updateDataForPaikanninKuopioLambda =
            InternalLambdas.createUpdateDataLambdaForPaikannin(
                stack,
                "paikannin-kuopio",
                5
            );
        ...
        new DigitrafficLogSubscriptions(
            stack,
            updateDataForPaikanninKuopioLambda
        );
    ...
    private static createUpdateDataLambdaForAutori(
        ...
        environment[MaintenanceTrackingMunicipalityEnvKeys.DOMAIN_NAME] =
            domain;
        environment[

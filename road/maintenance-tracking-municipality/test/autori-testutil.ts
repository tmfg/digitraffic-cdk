 ...
 * @param operations
 */
export function createApiRouteData(updated : Date, geometries : Geometry[], operations:string[]=[AUTORI_OPERATION_BRUSHING, AUTORI_OPERATION_PAVING, AUTORI_OPERATION_SALTING]) : ApiRouteData {
...
export function createApiContractData(name: string, endDate = moment().add(30, 'days').toDate()) : ApiContractData {
    return {
        id: randomString(),
        name: name,

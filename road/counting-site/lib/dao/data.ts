...
const SQL_FIND_VALUES_FOR_MONTH = `select csc.domain_name, csc.name counter_name, csut.name user_type, csd.data_timestamp, csd.interval, csd.count, csd.status 
...
export function findDataForMonth(
    ...
    return db.manyOrNone(PS_FIND_VALUES_FOR_MONTH, [
        startDate,
        endDate,
        nullString(domainName),
        nullNumber(counterId),

...
const PS_ALL_COUNTERS = new pgPromise.PreparedStatement({
    name: "select-counters",
    text: SQL_ALL_COUNTERS
});

const PS_FIND_COUNTERS_FEATURE_COLLECTION = new pgPromise.PreparedStatement({
    name: "select-counters-feature-collection",
    text: SQL_ALL_COUNTERS_FEATURE_COLLECTION
});

const PS_INSERT_COUNTER = new pgPromise.PreparedStatement({
    name: "insert-counter",
    text: SQL_INSERT_COUNTER
});

const PS_UPDATE_COUNTER = new pgPromise.PreparedStatement({
    name: "update-counter",
    text: SQL_UPDATE_COUNTER
});

const PS_UPDATE_COUNTER_TIMESTAMP = new pgPromise.PreparedStatement({

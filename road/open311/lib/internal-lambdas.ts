...
function createUpdateServicesLambda(
    ...
    const updateServicesLambda = new lambda.Function(
        stack,
        updateServicesId,
        lambdaConf
    );
...
function createUpdateStatesLambda(
    ...
    const updateStatesLambda = new lambda.Function(
        stack,
        updateStatesId,
        lambdaConf
    );
...
function createUpdateSubjectsLambda(
    ...
    const updateSubjectsLambda = new lambda.Function(
        stack,
        updateSubjectsId,
        lambdaConf
    );
    createSubscription(
        updateSubjectsLambda,
        updateSubjectsId,
        props.logsDestinationArn,
        stack
    );
...
function createUpdateSubSubjectsLambda(
    ...
    const updateSubSubjectsLambda = new lambda.Function(
        stack,
        updateSubSubjectsId,
        lambdaConf
    );
    createSubscription(
        updateSubSubjectsLambda,
        updateSubSubjectsId,
        props.logsDestinationArn,
        stack
    );

import {
  ...
  type ServiceRequestWithExtensions,
...
export function findAll(
  ...
  return db
    .manyOrNone<DbServiceRequest>(
      `${SELECT_REQUEST} ORDER BY service_request_id`,
    )
...
export function find(
  ...
  return db.oneOrNone(ps).then((
    r: DbServiceRequest,
  ) => (r === null ? null : toServiceRequest(r)));
}
...
export function createEditObject(
  ...
  const editObjectWithLonLat =
    ...
    // @ts-ignore
    serviceRequest.long !== "" && serviceRequest.lat !== "" ? editObject : {
      ...serviceRequest,
      ...{
        long: null,
        lat: null,

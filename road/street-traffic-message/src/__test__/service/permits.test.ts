...
describe(
    ...
    dbTestBase((db: DTDatabase) => {
        ...
        test("findPermitsInGeojson - GeometryCollection with multiple members is separated", async () => {
            const apiPermit = {
                sourceId: "123abc",
            ...
            apiPermit.gmlGeometryXmlString =
                '<gml:Point srsName="http://www.opengis.net/gml/srs/epsg.xml#3880"> <gml:pos>25483500.000 6661970.000</gml:pos> </gml:Point>';
            await insertPermitOrUpdateGeometry(db, apiPermit);

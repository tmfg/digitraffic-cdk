...
export const handler = async () => {
    ...
    await checker.expect200("/prod/api/counters/beta/metadata", rc.checkJson((json: MetadataResponse) => {
    ...
    await checker.expect200("/prod/api/counters/beta/counters/Oulu", ResponseChecker.forGeojson().checkJson((json: FeatureCollection) => {

...
export const nauticalWarningSchema: apigateway.JsonSchema = {
    ...
    properties: {
        ...
        fairwayInfo: {
            ...
            description:
                "Fairway features related to the nautical warning (separated by line breaks)",
        },
        locationEn: {
            type: apigateway.JsonSchemaType.STRING,
        ...
        navigationLineInfo: {
            ...
            description:
                "Navigation line features related to the nautical warning (separated by line breaks)",
        },
        navtex: {

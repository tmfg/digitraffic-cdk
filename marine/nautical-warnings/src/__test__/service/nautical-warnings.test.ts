import { dbTestBase, insertActiveWarnings, insertArchivedWarnings } from "../db-testutil.js";
import {
    getActiveWarnings,
    getArchivedWarnings,
...
import { TEST_WARNINGS_EMPTY_VALID, TEST_ACTIVE_WARNINGS_VALID } from "./nautical-warnings-test-constants.js";
...
describe(
    ...
    dbTestBase((db: DTDatabase) => {
        ...
        test("updateNauticalWarnings - valid geojson", async () => {
            jest.spyOn(NauticalWarningsApi.prototype, "getActiveWarnings").mockResolvedValue(TEST_ACTIVE_WARNINGS_VALID);
            jest.spyOn(NauticalWarningsApi.prototype, "getArchivedWarnings").mockResolvedValue(TEST_WARNINGS_EMPTY_VALID);

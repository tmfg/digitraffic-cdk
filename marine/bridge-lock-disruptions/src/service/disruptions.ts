...
export const BRIDGE_LOCK_DISRUPTIONS_DATA_TYPE =
  "BRIDGE_LOCK_DISRUPTIONS" as const;
export const BRIDGE_LOCK_DISRUPTIONS_CHECK =
  "BRIDGE_LOCK_DISRUPTIONS_CHECK" as const;
...
export async function saveDisruptions(
...
export async function fetchRemoteDisruptions(
  endpointUrl: string,
): Promise<SpatialDisruption[]> {

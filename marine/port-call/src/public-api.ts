...
export class PublicApi {
    ...
    createResources(publicApi: DigitrafficRestApi): Resource {
        ...
        const v2Resource = publicApi.addResourceWithCorsOptionsSubTree(pcResource, "v2");
    ...
    createVisitEndpoint(stack: DigitrafficStack, visitResource: Resource): void {
        ...
        const visitModel = addServiceModel("VisitModel", this.publicApi, visitSchema);
        ...
        ["GET", "HEAD"].forEach((httpMethod) => {
            visitResource.addMethod(httpMethod, visitsIntegration, {
                apiKeyRequired: true,
                methodResponses: [
                    DigitrafficMethodResponse.response200(visitModel, MediaType.APPLICATION_JSON_UTF8),
        ...
        this.publicApi.documentResource(visitResource, DocumentationPart.queryParameter("from", "Limit visit timestamp(inclusive)"));
        this.publicApi.documentResource(visitResource, DocumentationPart.queryParameter("to", "Limit visit timestamp(exclusive)"));
    }
}
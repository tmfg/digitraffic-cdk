...
export const nemoVisitSchema = z
  .object({
      ...
      .object({
        vesselInformation: z
          .object({
            ...
            name: z.string().max(70).describe("Aluksen nimi"),
          })
          .strict(),
        voyageInformation: z
          .object({
            ...
            estimatedArrivalDateTime: z.coerce
              .date()
        ...
        portCallStatus: z
          .object({
            status: z.enum(VISIT_STATUS_VALUES).describe("Satamakäynnin tila "),
          })
          .strict(),
      })
      .strict(),

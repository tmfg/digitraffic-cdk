import * as EtasApi from "../../lib/api/etas";
import * as PortAreasService from "../../lib/service/portareas";

describe('api-etas', () => {

    const geometries = PortAreasService.getPortAreaGeometries();
    const hankoWest =
    ...
    test('getPortAreaGeometryForShip - FIHKO/OUT', () => {
        const geometry = EtasApi.getPortAreaGeometryForShip(geometries, {
            portcall_id: 0,
            locode: 'FIHKO',
            port_area_code: 'OUT',
            imo: 1

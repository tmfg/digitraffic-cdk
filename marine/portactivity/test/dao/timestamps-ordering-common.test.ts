    ...
    dbTestBase((db: DTDatabase) => {
        ...
        function generateOrderingTest(
            ...
            test(`find by ${idPropText} - most accurate first - lower`, async () => {
                const timestampSource1 = newTimestamp(
                    Object.assign(
                        {
                            mmsi: testMmsi,
                            locode: testLocode,
                ...
                const timestampSource2 = newTimestamp(
                    Object.assign(
                        {
                            mmsi: testMmsi,
                            locode: testLocode,
                ...
                const timestampSource3 = newTimestamp(
                    Object.assign(
                        {
                            mmsi: testMmsi,
                            locode: testLocode,
                ...
                expect(foundTimestamp.event_time_confidence_lower).toBe(
                    timestampSource2.eventTimeConfidenceLower
                );
                expect(foundTimestamp.event_time_confidence_upper).toBe(
                    timestampSource2.eventTimeConfidenceUpper
                );
            });

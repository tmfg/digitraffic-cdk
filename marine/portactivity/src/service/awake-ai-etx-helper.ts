...
export function isPortcallPrediction(
  ...
  return (
    ...
    (prediction as AwakeArrivalPortCallPrediction).portCallUrn.includes(
      digitrafficPortCallString,
    )
  );
}
...
export function isDigitrafficEtaPrediction(
  prediction: AwakeAiPrediction,
): boolean {
  return (
...
export function isDigitrafficEtdPrediction(
  prediction: AwakeAiPrediction,
): boolean {
  return (
...
export function voyageUnderwayOrNotStarted(

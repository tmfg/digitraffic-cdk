...
describe("RAMI message processing", () => {
    test("processRamiMessage - valid monitoredJourneyScheduledMessage is correctly processed", async () => {
    ...
    test("processRamiMessage - valid scheduledMessage is correctly processed", async () => {
    ...
    test("processRamiMessage - invalid message is correctly processed", async () => {

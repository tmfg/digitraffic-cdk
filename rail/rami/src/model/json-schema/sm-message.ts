export const ramiSmMessageJsonSchema = {
  ...
  definitions: {
    KafkaMessageHeaders: {
      type: "object",
      required: ["e2eId", "eventType", "source", "recordedAtTime"],
      ...
      properties: {
        ...
        organisation: {
          ...
          example: "",
          description:
            "Identifier of external organization that sends the message",
        },
        source: {
          type: "string",
        ...
        partitionKey: {
          ...
          example: "",
          description:
            "Partition key value. It will be valorized only if set by the producer.",
        },
        recordedAtTime: {
          type: "string",
          format: "date-time",
    ...
    ControlActionStatus: {
      ...
      type: "string",
      enum: ["draft", "pendingValidation", "validated", "cancelled"],
    },
    ControlActionType: {
    ...
    Situation: {
      type: "object",
      description:
        "An incident or deviation affecting the planned Public Transport service operation.",
      properties: {
        strictScope: {
        ...
        situationNumber: {
          type: "string",
          description:
            "Unique Identifier of the Situation for this specific version.",
        },
        severity: {
    ...
    StopMonitoring: {
      ...
      required: ["monitoredStopVisits"],
    },
    MonitoredStopVisit: {
      description:
        "A visit to a SCHEDULED STOP POINT by a VEHICLE as an arrival and /or departure. Associated with each MonitoredStopVisit is a MonitoredVehicleJourney instance, which may be populated to different levels of detail depending on the information known by PIS",
      allOf: [
        {
        ...
        },
        {
          ...
          properties: {
            monitoringRef: {
              type: "string",
              description:
                "Code of the stoppoint wich this Stopmonitoring is related to",
            },
            vehicleActivityNote: {
              type: "string",
              description: "Empty",
          ...
          required: ["monitoringRef", "monitoredVehicleJourney"],
        },
      ],
    },
    MonitoredStopVisits: {
      type: "array",
      description:
        "A list of visits to a SCHEDULED STOP POINT by VEHICLEs as arrivals and / or departures.",
      items: {
    ...
    MonitoredStopVisitCancellation: {
      description:
        "This structure in PIS is not used becouse all information related to the journey in the stop point (arrival, departure, cancellation)  are in the MonitoredvehicleJourney object ",
      allOf: [
        {
    ...
    FramedVehicleJourneyRef: {
      ...
      required: ["dataFrameRef", "datedVehicleJourneyRef"],
    },
    Via: {
      type: "object",
    ...
    PreviousCall: {
      description:
        "Information on a stop previously called at by the VEHICLE before the current stop.",
      allOf: [
        {
        ...
        },
        {
          ...
          properties: {
            vehicleAtStop: {
              type: "boolean",
              description:
                "Wether VEHICLE is currently at stop.  Default is false",
            },
            extensions: {
              type: "object",
              properties: {
      ...
      allOf: [
        ...
        },
        {
          ...
          properties: {
            extensions: {
              description:
                "optional fields, used for replacements and sectoring",
              type: "object",
              properties: {
                custom: {
                  type: "string",
        ...
        },
        {
          ...
          properties: {
            ...
            timingPoint: {
              type: "boolean",
              description:
                "Whether the stop is a TIMING POINT, i.e. times are measured at it. In Some systems this is a measure of data quality as non-timing points are interpolated.",
            },
            extensions: {
              description: "optional fields, now not used",
              type: "object",
    ...
    StopAssignment: {
      type: "object",
      description:
        "Assignment of arrival/departure at scheduled STOP POINT to a physical QUAY (platform).",
      properties: {
        aimedQuayRef: {
          type: "string",
          description:
            "Reference (id) to the physical QUAY to use according to the planned timetable.",
        },
        aimedQuayName: {
          type: "string",
          description:
            "Scheduled Platform name. Can be used to indicate a platform change.",
        },
        expectedQuayRef: {
          type: "string",
          description:
            "Reference (id) to the physical QUAY to use according to the real-time prediction",
        },
        expectedQuayName: {
          type: "string",
    ...
    CallRealtimeGroup: {
      ...
      properties: {
        vehicleAtStop: {
          type: "boolean",
          description:
            "Wether VEHICLE is currently at stop.  Default is false. (Empty)",
        },
    ...
    CallRailGroup: {
      type: "object",
      description:
        "Elements describing the Properties specific to a rail CALL.",
      properties: {
        reversesAtStop: {
          type: "boolean",
          description:
            "Whether VEHICLE will reverse at stop. Default is 'false'. (Empty).",
        },
        platformTraversal: {
          type: "boolean",
          description: "(Empty).",
    ...
    CallPropertyGroup: {
      ...
      properties: {
        timingPoint: {
          type: "boolean",
          description:
            "Whether the stop is a TIMING POINT, i.e. times are measured at it. In Some systems this is a measure of data quality as non-timing points are interpolated. (EMpty).",
        },
        destinationDisplay: {
          type: "string",
    ...
    VehicleArrivalTimesGroup: {
      ...
      properties: {
        aimedArrivalTime: {
          ...
          format: "date-time",
          description:
            "Arrival time of VEHICLE at STOP POINT in either the original or Production Timetable. Date and time in [ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601).",
        },
        actualArrivalTime: {
          type: "string",
          format: "date-time",
          description:
            "Observed time of arrival of VEHICLE at STOP POINT. Date and time in [ISO 8601 format](Empty).",
        },
        expectedArrivalTime: {
          type: "string",
          format: "date-time",
          description:
            "Estimated time of arrival of VEHICLE at STOP POINT. Date and time in [ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601).",
        },
      },
    },
    ...
    MonitoredStopArrivalStatusGroup: {
      ...
      properties: {
        arrivalStatus: {
          type: "string",
          description:
            "Classification of the timeliness of the arrival part of the CALL according to a fixed list of values.",
          enum: [
            "onTime",
            "early",
            "delayed",
        ...
        arrivalProximityTextRef: {
          type: "string",
          description:
            "Uinique identifier of the proximity status of the arrival of the VEHICLE. (Empty).",
        },
        arrivalProximityTextName: {
          type: "string",
          description:
            "Arbitrary text string to show to indicate the proximity status of the arrival of the VEHICLE. (Empty).",
        },
        arrivalPlatformName: {
          type: "string",
        ...
        arrivalBoardingActivity: {
          ...
          enum: ["alighting", "noAlighting", "passthru"],
        },
    ...
    VehicleDepartureTimesGroup: {
      ...
      properties: {
        aimedDepartureTime: {
          ...
          format: "date-time",
          description:
            "Departure time of VEHICLE from STOP POINT in either the original or Production Timetable. Date and time in [ISO 8601 format]",
        },
        actualDepartureTime: {
          type: "string",
          format: "date-time",
          description:
            "Actual observed time of departure of VEHICLE from STOP POINT. Date and time in [ISO 8601 format](Empty).",
        },
        expectedDepartureTime: {
          type: "string",
          format: "date-time",
          description:
            "Estimated time of departure of VEHICLE from STOP POINT. Date and time in [ISO 8601 format]",
        },
      },
    },
        ...
        },
        {
          ...
          properties: {
            ...
            earliestExpectedDepartureTime: {
              ...
              format: "date-time",
              description:
                "Earliest time at which VEHICLE may leave the stop.  Date and time in ISO 8601 format(Empty).",
            },
          },
        },
      ],
    ...
    HeadwayIntervalGroup: {
      ...
      properties: {
        aimedHeadwayInterval: {
          ...
          format: "duration",
          description:
            "For frequency based services, target interval between services at stop. (Empty)",
        },
        expectedHeadwayInterval: {
          type: "string",
          format: "duration",
          description:
            "For frequency based services, estimated interval between services at stop.(Empty)",
        },
      },
    },
    StopProximityGroup: {
      type: "object",
      description:
        "Elements describing the distance from the stop of a VEHICLE (Empty)",
      properties: {
        distanceFromStop: {
          type: "number",
          description:
            "Distance of VEHICLE from stop of CALL as measured along ROUTE track. Positive value denotes distance before stop. Default unit is SI Kilometres.(Empty)",
        },
        numberOfStopsAway: {
          type: "integer",
          description:
            "Count of stops along SERVICE PATTERN between current position of VEHICLE and stop of CALL as measured along ROUTE track. (Empty)",
        },
      },
    },
    OnwardsCallGroup: {
      description:
        "Elements describing the CALL. Values for these elements can be specified on an production VEHICLE JOURNEY CALL. Each real-time journey CALL takes its values from the corresponding dated VEHICLE JOURNEY CALL.",
      allOf: [
        {
    ...
    OnwardVehicleArrivalTimesGroup: {
      ...
      properties: {
        aimedArrivalTime: {
          ...
          format: "date-time",
          description:
            "Target arrival time of VEHICLE at stop according to latest working timetable. Date and time in [ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601).",
        },
        expectedArrivalTime: {
          type: "string",
          format: "date-time",
    ...
    OnwardVehicleDepartureTimesGroup: {
      ...
      properties: {
        aimedDepartureTime: {
          ...
          format: "date-time",
          description:
            "Target departure time of VEHICLE according to latest working timetable. Date and time in [ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601).",
        },
        expectedDepartureTime: {
          type: "string",
          format: "date-time",
          description:
            "Estimated time of departure of VEHICLE Date and time in [ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601).",
        },
        provisionalExpectedDepartureTime: {
          type: "string",
          format: "date-time",
          description:
            "Expected departure time of VEHICLE without waiting time due to operational actions.(Empty).",
        },
        earliestExpectedDepartureTime: {
          type: "string",
          format: "date-time",
          description:
            "Earliest time at which VEHICLE may leave the stop. Used to secure connections. Used for passenger announcements. Date and time in ISO 8601 format (Empty).",
        },
      },
    },
    ...
    JourneyPatternInfoGroup: {
      ...
      properties: {
        journeyPatternRef: {
          type: "string",
          description:
            "Identifier (JourneyPatternCode) of JOURNEY PATTERN that journey follows. (Empty).",
        },
        vehicleModeRef: {
          type: "string",
          description:
            "Unique identifier of a method of transportation such as bus, rail, etc. TPEG Pti21 classification. (Empty).",
        },
        vehicleModeName: {
          type: "string",
          description:
            "Text description of a method of transportation. (RAIL).",
        },
        publishedLineName: {
          type: "string",
          description:
            "Name or Number by which the LINE is known to the public. (eg. Y U L E A P).",
        },
        directionName: {
          type: "string",
          description:
            'Name of the relative direction the VEHICLE is running along the LINE, for example, "inbound" or "outbound”. (Empty).',
        },
      },
    },
    ...
    BasicServiceInfoGroup: {
      ...
      properties: {
        operatorRef: {
          type: "string",
          description:
            "Identifier (OperatorCode) of OPERATOR of journey. (Empty).",
        },
        productCategoryRef: {
          type: "string",
          description:
            "Identifier of a product category of the journey – (eg. S HL IC).",
        },
        serviceFeatureRef: {
          type: "array",
          description:
            "Identifier (ServiceFeatureCode) of a Service Feature (Empty).",
          items: {
            type: "string",
          },
        },
    ...
    JourneyInfoGroup: {
      type: "object",
      description:
        "Elements describing a VEHICLE JOURNEY. Values for these elements can be specified on an annual schedule",
      properties: {
        vehicleJourneyName: {
          type: "string",
        ...
        journeyNote: {
          type: "string",
          description:
            "Additional descriptive text associated with journey. (Empty)",
        },
      },
    },
    ...
    ProgressDataQualityGroup: {
      type: "object",
      description:
        "Elements describing the quality of real-time progress data of a journey.",
      properties: {
        dataSource: {
          type: "string",
        ...
        inCongestion: {
          type: "boolean",
          description:
            "Whether the vehicle is in congestion. If not present, not known. (Empty).",
        },
        inPanic: {
          type: "boolean",
          description:
            "Whether the vehicle alarm is on. Likely to indicate unpredictable progress. If not present, false. (Empty).",
        },
        predictionInaccurate: {
          type: "boolean",
          description:
            "Whether the prediction should be judged as inaccurate. (Empty).",
        },
      },
    },
    ProgressDataGroup: {
      ...
      properties: {
        ...
        locationRecordedAtTime: {
          ...
          format: "date-time",
          description:
            "Time at which location was recorded. If not present assume that the recorded at time on the containing delivery (Empty)",
        },
        bearing: {
          type: "number",
          description:
            "Bearing in degrees in which VEHICLE is heading. North = 0, clockwise. (Empty).",
        },
        progressRate: {
          type: "string",
          description:
            "Classification of the rate of progress of VEHICLE. (Unknown).",
          enum: [
            "noProgress",
            "slowProgress",
            "normalProgress",
        ...
        engineOn: {
          ...
          default: true,
          description:
            "Whether the engine of the vehicle is on. Default is 'true' (Empty)",
        },
        velocity: {
          type: "number",
          description:
            "Velocity of vehicle in metres per second. Either actual speed or average speed may be used. (Empty).",
        },
        occupancy: {
          type: "string",
          description: "How full VEHICLE is. If omitted, not known. (Empty).",
          enum: ["full", "standingAvailable", "seatsAvailable"],
        },
        delay: {
          type: "string",
          format: "duration",
          description:
            "Delay in minutes. Information about delays are in call objects (Empty)",
        },
        vehicleStatus: {
          type: "string",
          description:
            "A classification of the progress state of the VEHICLE JOURNEY. (Empty)",
          enum: [
            "expected",
            "notExpected",
            "cancelled",
    ...
    TrainOperationalInfoGroup: {
      description:
        "Operational information about the monitored VEHICLE JOURNEY. (Empty)",
      type: "object",
      properties: {
        trainNumbers: {
          type: "array",
          ...
          items: {
            ...
            properties: {
              trainNumberRef: {
                type: "string",
                description:
                  "UE regulation 454/2011 primary code or UIC Train Number (Empty)",
              },
            },
          },
        },
    ...
    MonitoredCallingPatternGroup: {
      ...
      properties: {
        previousCalls: {
          type: "array",
          description:
            "Information on stop required and onward calls are present. No previous call are available. (Empty)",
          items: {
        ...
        onwardCalls: {
          type: "array",
          description:
            "Information on calls at the intermediate stops beyond the current stop, up to and including the DESTINATION. ",
          items: {
        ...
        isCompleteStopSequence: {
          type: "boolean",
          description:
            "Whether the call sequence is simple, i.e. represents every call of the route and so can be used to replace a previous call sequence. ",
        },
      },
    },
    AbstractItem: {
      ...
      properties: {
        recordedAtTime: {
          ...
          format: "date-time",
          description:
            "Time at which data was recorded. Date and time in [ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601).",
        },
      },
      required: ["recordedAtTime"],
    },
        ...
        },
        {
          ...
          properties: {
            monitoringRef: {
              type: "string",
              description:
                "Reference to a Stop Monitoring point at which visits happen",
            },
            visitNumber: {
              type: "integer",
              description:
                "For JOURNEY PATTERNs that involve repeated visits by a VEHICLE to a stop, the VisitNumber is used to distinguish each separate visit.",
            },
            vehicleJourneyRef: {
              $ref: "#/definitions/FramedVehicleJourneyRef",
            },
    ...
    ReplacementType: {
      type: "string",
      enum: ["ARRIVAL", "DEPARTURE", "ARRIVALDEPARTURE"],
    },
    ...
    Vehicle: {
      ...
      properties: {
        ...
        vehicleModelDirection: {
          description:
            "direction related to startingSector of the first wagon ",
          type: "string",
          enum: ["N", "S"],
        },
        vehicleElements: {
    ...
    VehicleElement: {
      ...
      properties: {
        ...
        position: {
          description:
            "position of the wagon when counting locomoives and wagons from the start of the train",
          type: "integer",
        },
        commercialClass: {
          type: "string",
        ...
        locomotiveType: {
          description:
            "type of locomotive if vehicleElementKind is Locomotive, it could be empty",
          type: "string",
        },
      },
    },
    ...
    MonitoredCallExtension: {
      ...
      properties: {
        ...
        previousLinks: {
          type: "array",
          description:
            "Links ordered from this MonitoredCall to the previous MonitoredCall of the route.",
          items: {
            type: "string",
          },
        },
        onwardLinks: {
          type: "array",
          description:
            "Links ordered from this MonitoredCall to the next MonitoredCall of the route.",
          items: {
            type: "string",
          },
        },
    ...
    MonitoredVehicleJourneyExtension: {
      ...
      properties: {
        ...
        registrationNumber: {
          type: "string",
          description:
            "Serial Number that uniquely identifies a Vehicle within the owner organization.",
          example: "MATR_101",
          minLength: 0,
          maxLength: 255,
        },
        isService: {
          type: "boolean",
          description:
            "Whether the journey type is service or technical. Default false.",
        },
        usage: {
        ...
        contracts: {
          type: "array",
          description:
            "List of contracts associated with the monitored journey.",
          items: {
    ...
    Contract: {
      ...
      properties: {
        ...
        contractDate: {
          ...
          format: "date-time",
          description:
            "The date and time of Contact. Date and time in [ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601).",
        },
        customerDisplayName: {
          type: "string",
    ...
    ServiceJourneyInterchange: {
      ...
      properties: {
        ...
        journeyMeeting: {
          type: "boolean",
          description:
            "Whether the SERVICE JOURNEY INTERCHANGE is a JOURNEY MEETING. Default is 'false'.",
        },
        interchangeJourneyRef: {
          description:
            "A reference to the DATED VEHICLE JOURNEY (feeder/distributor based on feeder flag)",
          $ref: "#/definitions/FramedVehicleJourneyRef",
        },
        interchangeRole: {
        ...
        visitNumber: {
          type: "number",
          description:
            "For JOURNEY PATTERNs that involve repeated visits by a VEHICLE to the same stop, the VisitNumber is used to distinguish each separate visit. Default is 1. Will be higher for routes that visit the same stop twice.",
        },
      },
    },
    InterchangeRoleEnum: {
      type: "string",
      enum: ["Feeder", "Distributor"],
    },
    UsageTypeEnum: {
      type: "string",
      enum: ["passenger", "freight"],
    },
    StopExtraInfo: {
      type: "object",
      properties: {

export const ramiSmMessageJsonSchema = {
  ...
  "definitions": {
    ...
    "JourneyPartInfo": {
      ...
      "properties": {
        ...
        "trainNumberRef": {
          "type": "string",
          "description":
            "Reference to TRAIN NUMBER for a JOURNEY PART. (Empty).",
        },
        "operatorRef": {
          "type": "string",
    ...
    "CallRealtimeGroup": {
      "type": "object",
      "description":
        "Elements describing the Real-time CALL properties. (Empty)",
      "properties": {
        "vehicleAtStop": {
          "type": "boolean",
          "description":
    ...
    "JourneyEndNamesGroup": {
      ...
      "properties": {
        "originRef": {
          "type": "string",
          "description":
            "The identifier of the origin of the journey (eg. HKI)",
        },
        "originName": {
          "type": "string",
    ...
    "MonitoredVehicleJourneyExtension": {
      ...
      "properties": {
        ...
        "vehicleCodes": {
          "type": "array",
          "description":
            "The unique string that identifies the phisical vehicle",
          "items": {
            "type": "string",
            "minLength": 0,
            "maxLength": 255,
    ...
    "ServiceJourneyInterchange": {
      ...
      "properties": {
        ...
        "stopPointRef": {
          "type": "string",
          "description":
            "Identifier of Stop Point where the coincidence occurs.",
        },
        "stopPointName": {
          "type": "string",

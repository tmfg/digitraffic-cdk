...
export type GetActiveMessagesEvent = z.infer<
  typeof getActiveMessagesLambdaEvent
>;
...
export type GetMessagesUpdatedAfterEvent = z.infer<
  typeof getMessagesUpdatedAfterLambdaEvent
>;

            ...
            .object({
                audioTexts: z
                    .array(
                        z
                            .object({
                                language: z.string().describe("identifies the language of the content"),
                                audioText: z.string().describe("audio text used for tts system")
                            })
                            .describe(
                ...
                deliveryRules: z
                    ...
                    .nullable(),
                deliveryType: z
                    .union([z.literal("ON_EVENT"), z.literal("ON_SCHEDULE"), z.literal(null)])
                    .describe("delivery type of message associated with vehicle journeys")
            })
            .describe(
        ...
        videoTexts: z
            .array(
                z
                    ...
                    .describe("video message content to be delivered for monitored journey scheduled message")
            )

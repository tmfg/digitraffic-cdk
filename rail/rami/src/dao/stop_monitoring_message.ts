...
create index smm_train_number_i on rami_stop_monitoring_message(train_number, train_departure_date);
create index smm_created_i on rami_stop_monitoring(created_db);

*/

const SQL_INSERT_MESSAGE = `
INSERT INTO rami_stop_monitoring_message(id, train_number, train_departure_date, message)

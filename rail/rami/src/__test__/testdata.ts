          ...
          audioText: [
            {
              language: "en_GB",
              text:
                "Attention. We perform monthly tests of the fire alarm system at the railway station. In connection with the tests, the alarm bells will soon ring for a short time. The fire alarm test does not require leaving the building. We apologize for the disturbance.",
            },
            {
              language: "fi_FI",
              text:
                "Huomio! Suoritamme rautatieasemalla paloilmoitinjärjestelmän kuukausitestejä. Testien yhteydessä hälytyskellot soivat hetken kuluttua lyhyen ajan. Palokellojen testi ei edellytä rakennuksesta poistumista. Pahoittelemme häiriötä.",
            },
            {
              language: "sv_SE",
              text:
                "Observera. Vi utför månatliga tester av brandlarmsystemet på järnvägsstationen. I samband med testerna ringer varningsklockorna snart en kort stund. Brandlarmtestet kräver inte att man lämnar byggnaden. Vi ber om ursäkt för störningen.",
            },
          ],
          media: null,
          ...
          videoTexts: [
            {
              language: "en_GB",
              text:
                "We perform monthly tests of the fire alarm system at the railway station. In connection with the tests, the alarm bells will soon ring for a short time. The fire alarm test does not require leaving the building. We apologize for the disturbance.",
            },
            {
              language: "fi_FI",
              text:
                "Suoritamme rautatieasemalla paloilmoitinjärjestelmän kuukausitestejä. Testien yhteydessä hälytyskellot soivat hetken kuluttua lyhyen ajan. Palokellojen testi ei edellytä rakennuksesta poistumista. Pahoittelemme häiriötä.",
            },
            {
              language: "sv_SE",
              text:
                " Vi utför månatliga tester av brandlarmsystemet på järnvägsstationen. I samband med testerna ringer varningsklockorna snart en kort stund. Brandlarmtestet kräver inte att man lämnar byggnaden. Vi ber om ursäkt för störningen.",
            },
          ],
          deliveryRules: {

...
class TestDumpCompositions(unittest.TestCase):
    ...
    def test_archives_previous_month_compositions(self):
        """
        ...
        Then:  28 API calls are made (one per day of February),
               ...
               zip contains 28 JSON files named '{date}_compositions.json',
        ...
        with mock_aws():
            ...
            with zipfile.ZipFile(io.BytesIO(zip_bytes), "r") as zf:
                ...
                self.assertEqual(filenames[0], "2026-02-01_compositions.json")
                self.assertEqual(filenames[-1], "2026-02-28_compositions.json")
                ...
                with patch.object(dump_compositions, "datetime") as mock_dt:
                    ...
                    with patch.dict(os.environ, {"DUMP_BUCKET_NAME": BUCKET_NAME}):
                        ...
                        with self.assertRaises(requests.HTTPError):
                            dump_compositions.lambda_handler({}, context)

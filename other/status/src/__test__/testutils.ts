...
export function setTestEnv(): void {
  ...
  setEnvVariable(
    ...
    CHECK_TIMEOUT_SECONDS.toString(),
  );
  setEnvVariable(
    StatusEnvKeys.INTERVAL_MINUTES,
    CHECK_INTERVAL_MINUTES.toString(),
  );
  setEnvVariable(
    StatusEnvKeys.GITHUB_WORKFLOW_FILE,
    "update_status_from_nodeping.yml",
  );
  setEnvVariable(
    StatusEnvKeys.GITHUB_UPDATE_MAINTENANCE_WORKFLOW_FILE,
    "update_started_maintenance.yml",
  );

...
import { EndpointHttpMethod, EndpointProtocol, MonitoredEndpoint } from "../../lib/app-props";
import { HOST_URL, mockSecretManager, setTestEnv } from "../testutils";
...
describe("NodePing API test", () => {
    beforeAll(() => {
        setTestEnv();
        mockSecretManager();
        secretHolder = SecretHolder.create();
        nodepingApi = makeApi();
    });

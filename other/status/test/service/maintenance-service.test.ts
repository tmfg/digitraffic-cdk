import { emptySecretHolder } from "../testutils";
import { NodePingApi, NodePingCheck, NodePingNotification } from "../../lib/api/nodeping-api";
import { StatuspageApi, StatuspageMaintenance, StatuspageMaintenances } from "../../lib/api/statuspage";
import * as maintenanceService from "../../lib/service/maintenance-service";
import { CStateStatuspageApi } from "../../lib/api/cstate-statuspage-api";

        ...
        var e = {
                ...
                8287: (e, t, r) => {
                    ...
                    (Buffer.prototype.slice = function slice(e, t) {
                        ...
                        (Buffer.prototype.readFloatLE = function readFloatLE(e, t) {
                            return (
                                (e >>>= 0), t || checkOffset(e, 4, this.length), i.read(this, e, !0, 23, 4)
                            );
                        }),
                        (Buffer.prototype.readFloatBE = function readFloatBE(e, t) {
                            return (
                                (e >>>= 0), t || checkOffset(e, 4, this.length), i.read(this, e, !1, 23, 4)
                            );
                        }),
                        (Buffer.prototype.readDoubleLE = function readDoubleLE(e, t) {
                            return (
                                (e >>>= 0), t || checkOffset(e, 8, this.length), i.read(this, e, !0, 52, 8)
                            );
                        }),
                        (Buffer.prototype.readDoubleBE = function readDoubleBE(e, t) {
                            return (
                                (e >>>= 0), t || checkOffset(e, 8, this.length), i.read(this, e, !1, 52, 8)
                            );
                        }),
                    ...
                    function boundsError(e, t, r) {
                        if (Math.floor(e) !== e)
                            throw (
                                (validateNumber(e, r), new u.ERR_OUT_OF_RANGE(r || "offset", "an integer", e))
                            );
                        ...
                        (Seq.prototype[w] = !0),
                            ...
                            (Range.prototype.__iterator = function (e, t) {
                                ...
                                return new Iterator(function () {
                                    var a = i;
                                    return (
                                        (i += t ? -n : n), o > r ? iteratorDone() : iteratorValue(e, o++, a)
                                    );
                                });
                            }),
                        ...
                        (K[W] = !0),
                            ...
                            (HashCollisionNode.prototype.update = function (e, t, r, n, i, o, a) {
                                ...
                                if (r !== this.keyHash)
                                    return s
                                        ? this
                                        : (SetRef(a), SetRef(o), mergeIntoNode(this, e, t, r, [n, i]));
                                for (
                        ...
                        (ce[ue] = !0),
                            ...
                            mixin(Iterable, {
                                ...
                                isSuperset: function (e) {
                                    return (e = "function" == typeof e.isSubset ? e : Iterable(e)).isSubset(
                                        this
                                    );
                                },
                                keyOf: function (e) {
                ...
                7068: (e, t, r) => {
                    ...
                    e.exports = function baseIsEqualDeep(e, t, r, _, y, m) {
                        ...
                        if (B && !I)
                            return (
                                m || (m = new n()), g || f(e) ? i(e, t, r, _, y, m) : o(e, t, b, r, _, y, m)
                            );
                        if (!(1 & r)) {
                ...
                5606: (e) => {
                    ...
                    function cleanUpNextTick() {
                        a &&
                            i &&
                            ((a = !1), i.length ? (o = i.concat(o)) : (s = -1), o.length && drainQueue());
                    }
                    function drainQueue() {
                        if (!a) {
                        ...
                        (Sha.prototype._update = function (e) {
                            ...
                            for (var f = 0; f < 80; ++f) {
                                var l = ~~(f / 20),
                                    h =
                                        0 |
                                        ((((t = n) << 5) | (t >>> 27)) + ft(l, i, o, s) + u + r[f] + a[l]);
                    ...
                    n(Sha512, i),
                        ...
                        (Sha512.prototype._update = function (e) {
                            ...
                            for (var D = 0; D < 160; D += 2) {
                                ...
                                te =
                                    ((te =
                                        ((te = (te + J + getCarry((ee = (ee + X) | 0), X)) | 0) +
                                            Y +
                                    ...
                                    : ((a &&
                                      ...
                                      (function readDoubleQuotedScalar(e, t) {
                                          ...
                                          for (
                                              ...
                                              if (34 === s)
                                                  return (
                                                      captureSegment(e, r, e.position, !0), e.position++, !0
                                                  );
                                              if (92 === s) {
                                                  if (

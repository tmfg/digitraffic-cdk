import { NOT_ACCEPTABLE, handler } from "../../lambda/lambda-gzip-requirement.js";
import { requestHandlerCall, headersWithAcceptEncoding, expectRequest } from "./request-util.js";

...
export class DigitrafficStatisticsStack extends cdk.Stack {
  ...
  constructor(
    scope: Construct,
    id: string,
    statisticsProps: DigitrafficStatisticsProps,
  ...
  private setupStatisticsDomain(
    ...
    const apigwDomainName = new apigw.DomainName(this, "domain", {
      ...
      certificate: acm.Certificate.fromCertificateArn(
        this,
        "digitraffic-statistics-certificate",
        stack.statisticsProps.certificateArn,
      ),
      endpointType: apigw.EndpointType.REGIONAL,
    });
    apigwDomainName.addBasePathMapping(statisticsApi.restApi, {
      stage: statisticsApi.restApi.deploymentStage,
    });

    const zone = route53.HostedZone.fromLookup(
      this,
      "digitraffic-statistics-zone",
      {
        domainName: domainName,
      },
    );
